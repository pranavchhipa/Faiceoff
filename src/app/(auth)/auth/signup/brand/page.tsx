            ...
            <FormField label={label}>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={ph}
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-input bg-background text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/45 transition-all"
                />
              </div>
            </FormField>
          </motion.div>
          ...
          <FormField label="Password" hint="At least 8 characters.">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-11 py-3 rounded-xl border border-input bg-background text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/45 transition-all"
              />
